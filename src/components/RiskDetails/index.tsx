  ...
  return (
    <section className="report-card risk-details">
      ...
      {data.categories.map((category) => {
        ...
        return (
          <div key={category.id} className={`detail-category isExpanded ? 'expanded' : 'not-expanded'}`}>
            <div
              className={`category-header isExpanded ? 'expanded' : 'not-expanded'}`}
            ...
            >
              ...
              <div className="abnormal-count">
                ...
                {/* 添加箭头图标 */}
                <i className={`expand-icon fa ${isExpanded ? 'fa-chevron-up' : 'fa-chevron-down'}`}></i>
              </div>
            </div>
